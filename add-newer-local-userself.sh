...
#The username, password, and hsot for the account will be displayed. 
...
then 
	...
	echo 'Create an account on the local system with the name of USER_NAME and a comment field of 
COMMENT. ' >&2
	exit 1
fi
...
#Check to see if useraddd command succeeded. 
if [[ "${?}" -ne 0 ]]
then 
